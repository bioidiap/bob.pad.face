...
"""
from bob.pad.face.database import BatlGovtPadDatabase

# Directory where the data files are stored.
# This directory is given in the .bob_bio_databases.txt file located in your home directory
ORIGINAL_DIRECTORY = "[YOUR_BATL_GOVT_DB_DIRECTORY]"
"""Value of ``~/.bob_bio_databases.txt`` for this database"""

ORIGINAL_EXTENSION = ".h5"  # extension of the data files

ANNOTATIONS_TEMP_DIR = "/idiap/temp/ageorge/batlgovt/annotations/"

PROTOCOL = 'baseline-infrared-50-join_train_dev'

database = BatlGovtPadDatabase(
    protocol=PROTOCOL,
