...
class BatlGovtPadFile(PadFile):
    ...
    def __init__(self, f,
        ...
        **Parameters:**
        ...
        super(BatlGovtPadFile, self).__init__(
...
class BatlGovtPadDatabase(PadDatabase):
    ...
    def __init__(
        ...
        **Parameters:**
        ...
        from bob.db.batlgovt import Database as LowLevelDatabase
        ...
        super(BatlGovtPadDatabase, self).__init__(
            name='batlgovt',
            protocol=protocol,
    ...
    def objects(self,
        ...
        **Returns:**
        ...
        files = [BatlGovtPadFile(f, stream_type, max_frames) for f in files]
